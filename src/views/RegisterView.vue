<template>
  <!--
    注册页 — 极简编辑 × 温暖学术
    作用：新用户注册，含用户名/邮箱/密码/确认密码/条款确认
    接口设计：完整照搬原版 authApi.register、authStore 逻辑
  -->
  <div class="auth-page">
    <main class="auth-container">
      ...
      <form class="auth-card" @submit.prevent="handleRegister">
        ...
        <div class="terms-row">
          ...
          <button type="button" class="btn-ghost btn-sm" @click="openPolicy">查看条款</button>
        </div>
        ...
        <div class="admin-entry">
          <button type="button" class="btn-ghost" @click="prefillAdmin">管理员入口</button>
        </div>
